...
class puWeightProducer(Module):
    ...
    def loadHisto(self, filename, hname):
        ...
        hist = tf.Get(hname)
       # print('Al test filename, hname, hist', filename, hname, hist)
        hist.SetDirectory(0)
        tf.Close()
        return hist
    ...
    def analyze(self, event):
        ...
        #print("Events number pu: ", event.event) 
...
#    'CMSSW_BASE']
pufile_data2018 = "%s/src/PhysicsTools/NanoAODTools/python/postprocessing/data/pileup/PileupHistogram_Bparked.root" % os.environ[
    'CMSSW_BASE']
